...
const CVRegMapping cvRegMapAmd64[] = {
    CVREGDAT(REGNUM_RAX, CV_AMD64_RAX) CVREGDAT(REGNUM_RCX, CV_AMD64_RCX)
        CVREGDAT(REGNUM_RDX, CV_AMD64_RDX) CVREGDAT(REGNUM_RBX, CV_AMD64_RBX)
            CVREGDAT(REGNUM_RSP, CV_AMD64_RSP) CVREGDAT(
                REGNUM_RBP, CV_AMD64_RBP) CVREGDAT(REGNUM_RSI, CV_AMD64_RSI)
                CVREGDAT(REGNUM_RDI, CV_AMD64_RDI) CVREGDAT(
                    REGNUM_R8, CV_AMD64_R8) CVREGDAT(REGNUM_R9, CV_AMD64_R9)
